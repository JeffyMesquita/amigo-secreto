...
//     `${EVOLUTION_API_URL}/message/sendText/your_instance_name`,
//     {
//       method: "POST",
//       headers: {
...
export async function POST(request: Request) {
  ...
  for (const match of matches) {
    const message = `Olá ${match.giver.name}! No amigo secreto "${body.title}", você tirou: ${match.receiver.name}. Boa sorte!`;
    try {
